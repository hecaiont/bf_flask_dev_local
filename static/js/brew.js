...
function ingredient_filed() {
	...
	var rdiv = 'removeclass'+room;
      divtest.innerHTML = '<ul class="nav justify-content-center m-1"><li class="nav-item col-sm-2 p-1"><div class="form-group m-0"><input type="number" min="0" class="form-control" name="rice#'+room+'" value="" placeholder="쌀"></div></li><li class="nav-item col-sm-2 p-1">  <div class="form-group m-0"><input type="number" min="0" class="form-control" name="water#'+room+'" value="" placeholder="물">  </div></li><li class="nav-item col-sm-2 p-1">  <div class="form-group m-0"><input type="number" min="0" class="form-control" name="yeast#'+room+'" value="" placeholder="누룩">  </div></li><li class="nav-item col-sm-2 p-1">  <div class="form-group m-0"><input type="number" min="0" class="form-control" name="subMaterials#'+room+'" value="" placeholder="부재료">  </div></li><li class="nav-item col-sm-2 p-1">  <div class="form-group m-0"><input type="number" min="0" class="form-control" name="interval#'+room+'" value="" placeholder="기간">  </div></li><li class="nav-item col-sm-2 p-1"><button type="button" class="btn btn-block btn-primary" onclick="remove_ingredient_filed('+ room +')">제거</button></li></ul>'
