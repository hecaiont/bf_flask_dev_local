...
function ingredient_filed() {
	...
	var rdiv = 'removeclass'+room;
      ...
      divtest.innerHTML = '<ul class="nav justify-content-center m-1"><li class="nav-item"><div class="form-group"><input type="number" class="form-control" id="rice" name="rice#'+room+'" value="" placeholder="쌀"></div></li><li class="nav-item">  <div class="form-group"><input type="number" class="form-control" id="water" name="water#'+room+'" value="" placeholder="물">  </div></li><li class="nav-item">  <div class="form-group"><input type="number" class="form-control" id="yeast" name="yeast#'+room+'" value="" placeholder="누룩">  </div></li><li class="nav-item">  <div class="form-group"><input type="number" class="form-control" id="subMaterials" name="subMaterials#'+room+'" value="" placeholder="부재료">  </div></li><li class="nav-item">  <div class="form-group"><input type="number" class="form-control" id="interval" name="interval#'+room+'" value="" placeholder="기간">  </div></li><li class="nav-item"><button type="button" class="btn btn-primary ml-1" onclick="remove_ingredient_filed('+ room +')">제거</button></li></ul>'
